...
#
# Notebook ini dibuat untuk diunggah ke repository GitHub sebagai file utama praktikum Modul 1.
#
# ## Spesifikasi Laptop
...
# %% [markdown]
# ## 1. Import Library
# Library yang digunakan adalah `pandas` dan `matplotlib` untuk membuat tabel serta grafik analisis.
...
# Data hasil implementasi disusun dalam bentuk `pandas DataFrame`.
...
#
# ### 5.1 Faktor Overhead
# Speedup yang diperoleh tidak mencapai kondisi ideal karena adanya beberapa faktor overhead, yaitu:
#
